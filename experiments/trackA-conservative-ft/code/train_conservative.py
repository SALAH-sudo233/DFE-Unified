...
if __name__ == '__main__':
    ...
    for name, param in model.named_parameters():
        if 'encoder' in name:
            ...
            frozen += param.numel()
    logger.info('Conservative FT: baseline=%s frozen_encoder_params=%d trainable_params=%d', ckpt_path, frozen, sum(p.numel() for p in model.parameters() if p.requires_grad))
